x# Boilerplate for layout tasks
Replace `<your_account>` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://Lilia-Mazur.github.io/layout_snake/)
- [TEST REPORT LINK](https://Lilia-Mazur.github.io/layout_snake/report/html_report/)
...
- Blocks must be put in 2 to 6 rows and stretched: each row must fit either 1, 2, or 3 blocks.
  See the screenshots [here](./rexferences).
