...
- [DEMO LINK](https://lem47.github.io/layout_snake/)
- [TEST REPORT LINK](https://lem47.github.io/layout_snake/report/html_report/)
...
- The first row is to be read from left to right, the second row from right to left, the third row again from left to right (this way we have a zigzag, or a snake).
