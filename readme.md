...
Replace `NikolayButylkov` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://NikolayButylkov.github.io/layout_snake/)
- [TEST REPORT LINK](https://NikolayButylkov.github.io/layout_snake/report/html_report/)
