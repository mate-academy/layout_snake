...
1. Replace `<your_account>` with you Github username in the links
    - [DEMO LINK](https://nazmeln.github.io/layout_snake/)
    - [TEST REPORT LINK](https://nazmeln.github.io/layout_snake/report/html_report/)
