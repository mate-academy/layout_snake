...
Replace `progmari` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://progmari.github.io/layout_snake/)
- [TEST REPORT LINK](https://progmari.github.io/layout_snake/report/html_report/)
